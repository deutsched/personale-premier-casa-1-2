    ...
    , activatePlugin: function(type) {
        ...
        // activate plugin
            ...
            jQuery.getScript('https://connect.facebook.net/en_US/all.js', function() {
                ...
                $container.append('<fb:fan profile_id="115816835104562" connections="6" stream=true width="364" height="350" css="https://www.db.com/italia/en/content/fbFanBox.css?2"></fb:fan>');
            });
            $stateSwitch
