...
flashBuilderSRC="/italia/en/data/js/flashbuilder.js"
...
generateFlashScript = function() {
    if (!document.getElementById("generatedFlashScript")) {
        ...
        generatedFlashScript.src="/italia/en/data/js/flashbuilder.js";
...
zo.loader = {
    config:{
        "flashbuilder":{"src":"/italia/en/data/js/flashbuilder.js","registered":false,"loaded":false}
...
toggleBox = function(id,defaultState,cookieMode,animSpeedRatio) {
    ...
    var cookieName="toggleBox_"+id+"_53250C92360A413E89C41984BE1DE203_ENG"
...
function dbclBuild() {
                            ...
                            var $wrapper = jQuery('<div class="cookie-wrapper"></div>')
                                .append('<div class="cookie-unit"><P>This website uses cookies in order to improve user experience. For more information about the cookies we use or to find out how you can disable cookies, see our <A href="/italia/en/content/cookies.html" target=_self>Cookies Notice</A>.</P></div>')    
                                .append($cookieButton)
...
function toggleSpeakerButton(thisObj)
{
    if (thisObj.className=="anchorReadSpeakPlay")
    {
         ...
         document.getElementById("readspeakerIFrame").src="https://app.readspeaker.com/cgi-bin/rsent?customerid=5441&type=7&lang=en&url="+location.href;
    }
    else
    {
...
function toggleReadSpeakerBoxButton(thisObj,pageURL)
{
    ...
    var intervalReadSpeaker = setInterval(function()
    {
        if (typeof(SWFObject) != 'undefined')
        {
            ...
            pathvar="src="+encodeURIComponent("https://app.readspeaker.com/cgi-bin/rsent?customerid=5441&type=podcast&lang=en&url=" + encodeURIComponent(top.location.href) );
            var so1765 = new SWFObject("/italia/en/docs/readspeaker_apollo.swf?"+pathvar, "mymovie", "167", "16", "8", "#FFFFFF");
...
/*
 * PUBLISHED: Wednesday, March 22, 2017 12:34 PM
 *
 *//**/
...
var langParameter="en";
var decoratorValue="dbag";
...
if (showMe) {
    nextToolbarObject=jQuery('<a></a>')
            ...
            .click(function() {
                printPopup=window.open('/italia/en/data/js/673.html','trgpopup','width=796,height=600,scrollbars=yes,resizable=no,menubar=yes,toolbar=yes'); 
                printPopup.focus();
            })
            .hover(
                function() { 
            ...
            .fancybox(
                {
                    ...
                    'height':700,
                    'type':'iframe',
                    'href':'https://www.deutsche-bank.de/pfb/feedbackmanager/?id=105&lang='+langParameter+'&decorator='+decoratorValue+'&',
                    'titleFormat':formatTitleOnlyClose
                }
            )
            .hover(
